...
#ifndef __OVS_DP_INTERFACE_H_
#define __OVS_DP_INTERFACE_H_ 1
...
struct ovs_key_ethernet {
	__u8	 eth_src[ETH_ADDR_LEN];
	__u8	 eth_dst[ETH_ADDR_LEN];
};
...
struct ovs_key_arp {
	...
	__be32 arp_tip;
	__be16 arp_op;
	__u8   arp_sha[ETH_ADDR_LEN];
	__u8   arp_tha[ETH_ADDR_LEN];
};

struct ovs_key_nd {
	__be32	nd_target[4];
	__u8	nd_sll[ETH_ADDR_LEN];
	__u8	nd_tll[ETH_ADDR_LEN];
};
